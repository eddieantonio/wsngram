...
# Modified by Eddie Antonio Santos <easantos@ualberta.ca>
# Modifications:
#  - given a function to calculate n-grams
#  - change left-padder to be ('t', '<START>')
...
class NgramModel(ModelI):
    ...
    # add cutoff
    def __init__(self, n, train, ngrammer, pad_left=True, pad_right=False,
        ...
        self._n = n
        self._lpad = ('t','<START>') * (n - 1) if pad_left else ()
